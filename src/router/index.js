...
const mainRoutes = {
  ...
  children: [
    ...
    {
      path: '/add_article',
      component: _import('modules/app/article-add-or-update'),
      name: 'add_article',
      hidden: true,
      meta: {
        title: '新增文章'
    ...
    // { path: '/review-detail/:id', component: _import('modules/review/detail'), name: 'review-detail', meta: { title: '审核详情', isTab: false } }
